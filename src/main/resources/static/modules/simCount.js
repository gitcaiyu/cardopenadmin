define(['layui', 'text!../../pages/simCount.html'], function (layui, simCount) {
    var form = layui.form;
        ...
        methods: {
            getPage: function () {
                ...
                layui.use('table', function(){
                    ...
                    table.render({
                        elem: '#data'
                        ,url:_this.ajax_url+'/simCount'
                        ,method:'post'
                        ,where:{orderMeal:_this.mealId,orderDiscount:_this.discount,orderState:_this.state,subTime:_this.subTime,subTimeE:_this.subTimeE,createTime:_this.createTime,createTimeE:_this.createTimeE,cardnum:_this.cardnum,simnum:_this.simnum}
                        ,cols: [[
                            {field:'order_id', title: '工单编号'}
                            ,{field:'sub_time', title: '申请时间',sort: true}
                            ,{field:'create_time', title: '完成时间', sort: true}
                            ,{field:'meal_name', title: '套餐资费',sort: true}
                            ,{field:'meal_code', title: '资费代码', sort: true}
                            ,{field:'discount_name', title: '优惠促销', sort: true}
                            ,{field:'cardNum', title: '选购号卡', sort: true}
                            ,{field:'SIMNum', title: 'SIM卡号', sort: true}
                        ]]
                        ,page: true
                        ,curr : 1
                        ,limits : [ 20, 50, 100, 1 ]
            ...
            orderExport:function () {
                var _this = this;
                // var datas={orderMeal:_this.mealId,orderDiscount:_this.discount,orderState:_this.state,subTime:_this.subTime,subTimeE:_this.subTimeE,createTime:_this.createTime,createTimeE:_this.createTimeE,cardnum:_this.cardnum,simnum:_this.simnum}
                // $.ajax({
                //     url: _this.ajax_url + '/simExport',
                //     type: 'post',
                ...
                //     }
                // })
                window.location.href = _this.ajax_url + '/simExport?orderMeal='+_this.mealId+'&orderDiscount='+_this.discount+'&orderState='+_this.state
                    +'&subTime='+_this.subTime+'&subTimeE='+_this.subTimeE
                    +'&createTime='+_this.createTime+'&createTimeE='+_this.createTimeE
                    +'&cardnum='+_this.cardnum+'&simnum='+_this.simnum
            }
        }
    }
    return {
